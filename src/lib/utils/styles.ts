...
import type { Button, CardForm, ContentMedia, Divider, Media } from '$payload-types'
...
export type ColorBlock = Divider['color']
...
export type PaddingBlock = CardForm['padding']
